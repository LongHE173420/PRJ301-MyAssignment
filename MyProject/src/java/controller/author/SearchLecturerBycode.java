 ...
 * @author Admin
 */
public class SearchLecturerBycode extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("view/search/searchLecturer.jsp").forward(request, response);
